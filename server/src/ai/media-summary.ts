...
function systemPrompt(): string {
  return [
    ...
    "Follow the transcript's dominant language. If the transcript is mostly Chinese, write natural Chinese. If it is mixed, keep the summary naturally mixed.",
...
function audioSystemPrompt(): string {
  return [
