...
DEVICE_NAME="${PRIVATE_MOMENTS_DEVICE_NAME:-}"
BUNDLE_ID="${PRIVATE_MOMENTS_BUNDLE_ID:-dev.privatemoments.app}"
...
if [[ -z "$DEVICE_NAME" ]]; then
  cat >&2 <<'MSG'
Set PRIVATE_MOMENTS_DEVICE_NAME to your paired iPhone name, then rerun:
